...
import { Book, Search, History, Star, Languages, Menu, X } from "lucide-react";
...
const StealthOverlay = ({ children }) => {
    ...
    return (
        <div className="fixed inset-0 z-[9999] bg-base-100 flex flex-col font-sans text-base-content overflow-hidden animate-in fade-in duration-200">
