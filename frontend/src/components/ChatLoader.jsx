...
function ChatLoader() {
  return (
    <div className="h-screen flex flex-col bg-black overflow-hidden">
      {/* Spoof Header */}
      <div className="flex-shrink-0 p-4 border-b border-white/5 flex items-center gap-3 bg-black/50 backdrop-blur-md">
      ...
      {/* Spoof Input Area */}
      <div className="flex-shrink-0 p-3 sm:p-4 border-t border-white/10 bg-black/50 backdrop-blur-md">
