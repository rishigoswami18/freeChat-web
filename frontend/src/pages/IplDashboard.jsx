    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white font-outfit">
            ...
            <nav className="sticky top-0 z-50 bg-[#050505]/80 backdrop-blur-2xl border-b border-white/5 px-6 py-4">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-6">
                        ...
                        >
                            <ArrowLeft className="size-5 text-white/60 group-hover:text-white transition-colors" />
                        </button>
                        <div>
                            <h1 className="text-2xl font-black italic tracking-tighter flex items-center gap-2">
                                IPL 2026 <span className="text-indigo-500 font-black px-2 py-0.5 bg-indigo-500/10 rounded-lg text-[10px] not-italic tracking-widest uppercase ml-2 animate-pulse">Hub</span>
                            </h1>
                            <p className="text-[10px] font-black text-white/30 uppercase tracking-[0.3em]">Exclusive Partnership Arena</p>
                        </div>
                    </div>
            ...
            <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 w-[90%] md:w-auto">
                ...
                >
                    <div className="flex items-center gap-4">
                        <div className="size-3 bg-red-600 rounded-full animate-pulse shadow-[0_0_15px_red]" />
                        <div className="flex flex-col">
                            <span className="text-[10px] font-black uppercase tracking-widest text-white/40">Next Big Event</span>
                            <span className="text-sm font-black italic tracking-tighter">IPL 2026 OPENER • MARCH 28</span>
                        </div>
                    </div>
