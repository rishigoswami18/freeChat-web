    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8 max-w-2xl mx-auto pb-24 sm:pb-8">
            <h1 className="text-2xl sm:text-3xl font-bold mb-1 flex items-center gap-2">
                <HeartHandshake className="text-pink-500" />
                Couple Profile
                <span className="text-[10px] bg-primary text-primary-content px-2 py-0.5 rounded-full animate-pulse ml-2">v2.1 Debug</span>
            </h1>
            <p className="text-[10px] opacity-30 mb-6 uppercase font-black">Latest Update: Love Notes Fully Integrated</p>

            {/* ===== COUPLED STATE ===== */}
            {coupleStatus === "coupled" && partner && (
                <div className="space-y-6">
                    {/* Romantic Note Section (Moved to TOP for visibility) */}
                    <div className="card bg-base-200 border-2 border-primary/30 shadow-2xl overflow-hidden group rounded-3xl">
